...
public class RivialServer implements Runnable{
    ...
    public boolean joinGame(Socket socket, int gameid, long timestamp) throws GameNotFoundException, PlayerNotFoundException {
        GameModel game = this.getGameWithID(gameid);
        game.resetTimer();
        return game.addPlayer(getPlayerWithSocket(socket), timestamp);
    }
